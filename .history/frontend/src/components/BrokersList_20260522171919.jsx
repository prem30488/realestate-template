...
const BrokersList = () => {
    ...
    useEffect(() => {
        const fetchBrokers = async () => {
            ...
            try {
                ...
                // Filter out deleted brokers
                const activeBrokers = response.data.brokers.filter(b => !b.isDeleted);
    ...
    return (
        <Box sx={{ bgcolor: '#f5f7fa', minHeight: '100vh', py: 8, px: 2 }}>
                                            ...
                                            <Box>
                                                ...
                                                {broker.city && (
                                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                                        <LocationIcon sx={{ fontSize: 14, color: '#6a11cb' }} />
